...
document.getElementById('findPathButton').addEventListener('click', () => {
    const startDisplay = document.getElementById('startBuildingInput').value;
    const endDisplay = document.getElementById('endBuildingInput').value;
    const startBuilding = displayNameToInternalName[startDisplay] || startDisplay;
    ...
    if (startBuilding === "_CURRENT_LOCATION_") {
        ...
        // Use current GPS position for pathfinding
